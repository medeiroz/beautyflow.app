        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate class="h-16">
                        <x-application-logo />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown :text="auth()->user()->name">
                    <x-dropdown.items :text="__('Profile')" :href="route('profile')" wire:navigate/>
                    <x-dropdown.items :text="__('Log Out')" wire:click="logout" />
                </x-dropdown>
            </div>
